...
@pytest.mark.parametrize('mode_param', ['commit', 'tree', 'blob', 'size', 'type', 'pretty'])
...
@unittest.mock.patch('git3Client.git3.get_repo_root_path', side_effect=NoRepositoryError('fatal: not a git repository (or any of the parent directories): .git'))
