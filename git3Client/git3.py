...
def main(args):
    ...
    # Branch
    sub_parser = sub_parsers.add_parser("branch", help="List and Create branches")
    sub_parser.add_argument(
        "-r", "--remotes", action="store_true", help="act on remote-tracking branches"
    )
    sub_parser.add_argument(
        "branchname",
        metavar="<branchname>",
    ...
    sub_parser.add_argument(
        "-b", action="store_true", help="Create a new branch with name new_branch"
    )
    sub_parser.add_argument("branch", metavar="<branch>", help="Checkout to <branch>")

    # Commit
    sub_parser = sub_parsers.add_parser(
        "commit", help="commit current state of index to current active branch"
    )
    sub_parser.add_argument(
        "-a",
        "--author",
    ...
    # Create
    sub_parser = sub_parsers.add_parser("create", help="create your remote repository")
    ...
    # Clone
    sub_parser = sub_parsers.add_parser("clone", help="create your remote repository")
    ...
    sub_parser.add_argument(
        "repo", nargs="?", default=".", help="directory name for new repo"
    )
    ...
    # Get-Address
    sub_parser = sub_parsers.add_parser(
        "get-address", help="Get blockchain wallet address"
    )
    ...
    sub_parser.add_argument(
        "sourceBranch", nargs="?", help="branch to be merged into the current branch"
    )
